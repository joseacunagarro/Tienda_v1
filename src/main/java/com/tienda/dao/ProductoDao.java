...
public interface ProductoDao extends JpaRepository<Producto, Long> {
    ...
    //Ejemplo de Filtro de Minimo de Existencias
    @Query("SELECT p FROM Producto p WHERE p.existencias >= :minExistencias ORDER BY p.existencias DESC")
    List<Producto> findByInventarioMayor(@Param("minExistencias") int minExistencias);
}
